 ...
 */
package de.ma.analyze.common.component;

import de.ma.analyze.common.AnalyzeConstants;
...
public class Component implements Serializable {
    ...
    private ComponentAttribute getReturnType() {
        return getAttributes().stream()
                .filter(att -> ComponentAttributeType.JAVA_RETURN_TYPE.equals(att.getType()))
                .findFirst()
                .orElse(null);
    }
}