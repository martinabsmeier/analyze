...
import de.am.analyze.parser.common.listener.SyntaxErrorListener;
import de.am.analyze.generated.parser.java.JavaLexer;
import de.am.analyze.generated.parser.java.JavaParser;
import de.am.analyze.parser.java.listener.JavaTypeListener;
...
public class JavaSourceParser extends SourceParserBase {
    ...
    public void initListeners(String revisionId) {
        ...
        addListener(new JavaTypeListener(revisionId));
    }
